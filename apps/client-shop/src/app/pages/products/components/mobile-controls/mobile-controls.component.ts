...
@Component({
  ...
  template: `
    ...
    <div class="lg:hidden border-t border-slate-100 bg-slate-50 w-full">
      <!-- First Controls Row -->
      <div class="flex items-center justify-between px-4 py-3 gap-4">
        <!-- View Toggle -->
        <div class="flex items-center gap-2 min-w-0">
          <span class="text-xs font-medium text-slate-700 whitespace-nowrap">View:</span>
          <p-selectButton
            [options]="viewOptions()"
            optionLabel="label"
            optionValue="value"
        ...
        <!-- Size System -->
        <div class="flex items-center gap-2 min-w-0">
          <span class="text-xs font-medium text-slate-700 whitespace-nowrap">Size:</span>
          <p-selectButton
      ...
      <div class="flex items-center justify-between px-4 py-3 border-t border-slate-200 gap-4">
        ...
        <div class="flex items-center gap-2 flex-1 min-w-0">
          <span class="text-xs font-medium text-slate-700 whitespace-nowrap">Sort:</span>
          <p-select
            [options]="sortOptions()"
        ...
        <!-- Items Per Page -->
        <div class="flex items-center gap-2 min-w-0">
          <span class="text-xs font-medium text-slate-700 whitespace-nowrap">Show:</span>
          <p-select
